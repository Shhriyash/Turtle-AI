...
Example Usage:
    ...
    from tools.email_tools import EmailTool
    ...
    from tools.email_tools import create_email_tool_from_env, validate_email_config
...
# Define what gets imported with "from tools.email_tools import *"
__all__ = [
    'EmailConfig',
    'EmailRequest', 
    'EmailResult',
